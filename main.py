...
# Function to scrape and save offers
def scrape_and_save_offers(url):
    ...
    try:
        ...
        single_offer_price = driver.find_elements(By.CSS_SELECTOR,
                                                  "div[data-testid='listing-item-header'] span.ev8qziy1.css-2ih7x0.e1a3ad6s0")
        ...
        if len(single_offer_price) > 0:
            ...
            # Save to file
            with open("my_data.txt", mode="a") as file:
                file.write("\n" + data_to_save)
        else:
...
# TODO 1:  refactor names and add sum of offers
